...
<html>
	...
	<body>
		...
		Effective date (mm/dd/yyyy): <input type="date" name="date" />
		<h5>EMPLOYEE INFORMATION</h5>
		<p>Name (Last, First, Middle initial): <input type="text" name="name" />
		Social Security number: <input type="text" name="ssn" /></p>
		<p>Date of birth: <input type="date" name="birth" />
		Date of hire: <input type="date" name="hire" />Marital status: <input type="text" name="marital" /></p>
		<h5>HEALTH INSURANCE</h5>
		<div style="float:left">
		<ul>Medical</ul>
		<ul><input type="radio" name="medical" value="Individual" />Individual</ul>
		...
		<ul><input type="radio" name="type1" value="HDHP W/HSA" />HDHP W/HSA</ul>
		...
		<div style="float:left">
		<ul>Dental</ul>
		<ul><input type="radio" name="dental" value="Individual" />Individual</ul>
		...
		<div style="float:left">
		<ul>I select the following plan (choose one):</ul>
		<ul><input type="radio" name="type2" value="Value" />Value</ul>
		<ul><input type="radio" name="type2" value="Value Plus" />Value Plus</ul>
		</div>
		<div style="float:left">
		<ul>Vision Plan</ul>
		<ul><input type="radio" name="vision" value="Individual" />Individual</ul>
    ...
    <tr>
     ...
     <tr>
        <td><input type="radio" name="medical1" value="check" /></td>
        <td><input type="radio" name="dental1" value="check" /></td>
		<td><input type="radio" name="vision1" value="check" /></td>
		...
		<td><input type="radio" name="student" value="Yes" /></td>
		<td><input type="text" name="relation" /></td>
		<td><input type="text" name="pcp" /></td>	
    </tr>
	  <tr>
        <td><input type="radio" name="medical2" value="check" /></td>
        <td><input type="radio" name="dental12" value="check" /></td>
		<td><input type="radio" name="vision12" value="check" /></td>
		<td><input type="text" name="name12" /></td>
		<td><input type="text" name="ssn12" /></td>
		<td><input type="date" name="date12" /></td>
		<td> 
			<input type="radio" name="gender12" value="male" />Male
			<input type="radio" name="gender12" value="female" />Female
        </td>
		<td><input type="radio" name="student12" value="Yes" /></td>
		<td><input type="text" name="relation12" /></td>
		<td><input type="text" name="pcp12" /></td>	
    </tr>
...
<div>Health Care Reimbursement Account&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			...
			<label> Amount: $ <input type="text" name="jine" /></label>
...
<div>Dependent Care Reimbursement Account&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			...
			<input type="radio" name="amount2" value="Waive participation" />
			<label>Waive participation</label>
</div>		
<h5>HEALTH SAVINGS ACCOUNT (HSA)</h5>
<div>Health Savings Account&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<label> Amount: $ <input type="text" name="amount3"  /></label>
</div>
<h5>LIFE INSURANCE</h5>
<div>Supplemental Life Insurance<input type="radio" name="amount4" value="1x base salary" />1x base salary
...
<div>Spouse/Domestic Partner <input type="radio" name="amount5" value=" $25,000" /> $25,000
...
<div>Dependent Child(ren)<input type="radio" name="amount6" value="$10,000" /> $10,000
...
<input type="radio" name="amount7" value="Waive participation" />  Waive participation</div>
...
<td>
<input type="radio" name="amount8" value="Primary" />  Primary
<input type="radio" name="amount8" value="Contingent" /> Contingent
</td>
<td>
<input type="text" name="benefit" />%<br/>
</td>
</tr>
<tr>
<td>
...
<td>
<input type="text" name="relationship3" />
</td>
<td>
<input type="radio" name="amount83" value="Primary" />  Primary
<input type="radio" name="amount83" value="Contingent" /> Contingent
</td>
<td>
<input type="text" name="benefit3" />%<br/>
</td>
</tr>
</table>
Employee signature<input type="text" name="employee" />Date<input type="text" name="datesign" /><br/>
Reviewed by<input type="text" name="review" />Entered<input type="text" name="entered" />
<div>
